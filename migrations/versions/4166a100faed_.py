...
Revision ID: 4166a100faed
Revises: 016cf1625c48
Create Date: 2023-10-15 18:37:36.175906
...
revision = '4166a100faed'
down_revision = '016cf1625c48'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('product_ids', sa.ARRAY(sa.Integer(), as_tuple=ForeignKey('products.product_id')), nullable=True),
