...
Revision ID: f1fbecfbdb2e
Revises: d86196644a64
Create Date: 2023-10-15 18:26:17.720308
...
revision = 'f1fbecfbdb2e'
down_revision = 'd86196644a64'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('price', sa.NullType(), nullable=True),
    ...
    sa.ForeignKeyConstraint(['product_ids'], ['products.product_id'], ),
